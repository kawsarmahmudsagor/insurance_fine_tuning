...
# -------------------- Tokenization --------------------
def tokenize(batch):
    """Tokenize and return PyTorch tensors directly for caching"""
    texts = [
        f"### Instruction:\n{q}\n\n### Response:\n{a}"
...
if os.path.exists(tokenized_path):
    ...
    # Convert all splits to PyTorch tensors for fast loading
...
trainer = Trainer(
    ...
    tokenizer=tokenizer  # Trainer will use pre-converted PyTorch tensors
)
